        ...
        <div className="bg-background min-h-screen text-foreground selection:bg-primary/30 relative">
            ...
            <main className="max-w-7xl mx-auto px-6 py-20">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <div className="inline-flex items-center space-x-2 px-3 py-1.5 bg-primary/10 text-primary/90 border border-primary/20 text-xs font-bold uppercase tracking-widest rounded-full mb-6">
                        <BookOpen className="w-4 h-4" />
                        <span>Central Form Repository</span>
                    </div>
                    <h1 className="text-4xl md:text-5xl font-serif tracking-tight leading-tight tracking-tight mb-6">
                        Statutory Document <span className="text-primary">Templates</span>
                    </h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {featuredForms.map((form) => (
                            <Link
                                href="/gfe/editor"
                                key={form.id}
                                className="group relative bg-background/50 backdrop-blur-sm border border-border/60 hover:border-primary/50 p-6 rounded-xl shadow-sm transition-all hover:shadow-primary/5 overflow-hidden flex flex-col h-full"
                            >
                                <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-100 transition-opacity">
                                    <CopyPlus className="w-16 h-16 text-primary -mr-4 -mt-4" />
                                </div>
                                <div className="relative z-10 flex-1">
                                    ...
                                    <h3 className="text-lg font-serif tracking-tight text-foreground mb-2 leading-snug group-hover:text-primary/90 transition-colors">
                                        {form.title}
                                    </h3>
                                ...
                                <div className="relative z-10 mt-5 pt-3 border-t border-border/40 flex items-center justify-between text-xs font-semibold text-primary">
