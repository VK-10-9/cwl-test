...
export default function ButtonDemo() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-8 p-8 bg-bg">
      <h1 className="text-2xl font-heading text-text">Neobrutalist Button Variants</h1>
      ...
      <h2 className="text-xl font-heading text-text mt-8">Original Variants (Preserved)</h2>
