        ...
        <div className="bg-background min-h-screen text-foreground selection:bg-primary/30 relative">
            ...
            <main className="max-w-7xl mx-auto px-6 py-20">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <div className="inline-flex items-center space-x-2 px-3 py-1.5 bg-foreground/5 text-foreground/80 border border-border/50 text-xs font-sans font-semibold uppercase tracking-widest rounded-full mb-6">
                        <FileSignature className="w-4 h-4 text-primary" />
                        <span>AI Contract Generator</span>
                    </div>
                    <h1 className="text-4xl md:text-5xl font-serif font-black leading-tight tracking-tight mb-6">
                        Business & Startup <span className="text-primary">Templates</span>
                    </h1>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {category.templates.map((template) => (
                                    <Link
                                        ...
                                        key={template.id}
                                        className="group relative bg-[#0A0A0B] border border-white/5 shadow-2xl hover:border-primary/50 p-6 rounded-xl shadow-sm transition-all hover:shadow-primary/5 flex flex-col h-full"
                                    >
                                        <div className="relative z-10 flex-1">
                                            <div className="flex items-center justify-between mb-4">
                                                <div className="flex items-center space-x-2 text-[10px] font-sans font-semibold uppercase tracking-widest text-muted-foreground">
                                                    <FileText className="w-3.5 h-3.5 opacity-70" />
                                                    <span>Contract Generation</span>
                                                </div>
                                                {template.isPopular && (
                                                    <span className="text-[10px] font-sans font-semibold uppercase tracking-widest text-primary/90 bg-primary/10 px-2.5 py-1 rounded-full border border-primary/20">
                                                        Popular
                                                    </span>
                                                )}
                                            </div>
                                            <h3 className="text-xl font-serif font-black text-foreground mb-3 leading-snug hover:text-primary transition-colors">
                                                {template.name}
                                            </h3>
                                        ...
                                        <div className="relative z-10 mt-6 pt-4 border-t border-border/40 flex items-center justify-between text-sm font-semibold text-primary">
